...
WebUI.setText(findTestObject('Object Repository/Fitur Register/input__usernameRegisterPage'), 'tugasyudha1')

WebUI.click(findTestObject('Object Repository/Fitur Register/label_Email'))

WebUI.setText(findTestObject('Object Repository/Fitur Register/input__emailRegisterPage'), 'tugasyudha1@gmail.com')
