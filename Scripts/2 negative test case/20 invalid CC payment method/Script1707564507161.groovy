...
WebUI.setText(findTestObject('Object Repository/invalid CC Payment Method/input_OR_username'), 'yudhatesting2')

WebUI.setText(findTestObject('Object Repository/invalid CC Payment Method/input_Username_password'), 'Dharmayudha2')
